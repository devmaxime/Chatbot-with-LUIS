...
class MainDialog extends ComponentDialog {
    ...
    async actStep(stepContext) {
        ...
        case 'bookingIntent': {
            ...
            bookingDetails.end_date = this.luisRecognizer.getEndDate(luisResult).end_date;
            bookingDetails.budget = this.luisRecognizer.getBudget(luisResult).budget;
    ...
    async finalStep(stepContext) {
        ...
        if (stepContext.result) {
            ...
            const msg = `I have you booked to ${ result.destination } from ${ result.origin } on ${ result.str_date } and come back on ${ result.end_date }. Your budget is ${ result.budget }`;
